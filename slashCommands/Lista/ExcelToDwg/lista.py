...
def writeFiles(elemento):
  ...
  doc = ezdxf.readfile(fullPath + '/BLOCO-BRANCO.dxf')
  msp = doc.modelspace()
  ...
  doc.saveas(fullPath + "/" + elemento + "_LISTA.dxf")

  with zipfile.ZipFile(fullPath +'/BLOCOS-BRANCOS.zip', 'a', compression=zipfile.ZIP_DEFLATED) as myzip:
     myzip.write(fullPath + "/" + elemento + "_LISTA.dxf", arcname= elemento + "_LISTA.dxf")
...
with zipfile.ZipFile(fullPath +'/BLOCOS-BRANCOS.zip', 'w', compression=zipfile.ZIP_DEFLATED) as myzip:
   myzip.write(fullPath + '/BLOCO-BRANCO.dxf', arcname='BLOCO-BRANCO.dxf')

for elemento in nomes_planilhas:
   writeFiles(elemento)

print(fullPath +'/BLOCOS-BRANCOS.zip')